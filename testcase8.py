...
def runtest():
    print('Test case: Striker hit right after movement', file=sys.stderr)
    infofilename = 'test.log'
    armlist = []
    armlist.append([0, 3, 798, 0.421, 959])
    strikerlist = []
    strikerlist.append([661, 0, 0, 0, 0, 1, 0, 0, 0])
