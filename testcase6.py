...
def runtest():
    ...
    checkinstructionlist.checkinstructionlist(armlist, startpositions=[shimon.arm.positiontable[0], shimon.arm.positiontable[2], shimon.arm.positiontable[7], shimon.arm.positiontable[9]], logfilename=logfilename)
